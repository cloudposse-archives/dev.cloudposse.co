...
File a GitHub [issue](https://github.com/cloudposse/dev.cloudposse.co/issues), send us an [email][email] or join our [Slack Community][slack].
...
Please use the [issue tracker](https://github.com/cloudposse/dev.cloudposse.co/issues) to report any bugs or file feature requests.
